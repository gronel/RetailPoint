...
Module modFunction
    ...
    Function getUser(ByVal srcUser As String, ByVal srcPassword As String) As Boolean
        ...
        Dim xCommand As New SqlCommand("Get_Employee'" & "getuser" & "','" & "" & "'", xConn)
        ...
        While xReader.Read
            If xReader("UserName").ToString = srcUser And xReader("UserPassword").ToString = srcPassword Then
                ...
                CurrUser.User_Department = xReader("DeptCode").ToString
    ...
    Public Sub setUserRights(ByVal frmName As String)
        ...
        While dr.Read()
            With MainForm
                ...
                If dr("canVoid") = True Then
                    MainForm.tsVoid.Visible = True
                Else
                    MainForm.tsVoid.Visible = False
                End If
                ...
                '' separator after edit
                If dr("canAdd") = True Or dr("canEdit") = True Then
                    .sepAdd.Visible = True
                Else
                    .sepAdd.Visible = False
                End If
