        ...
        Try
            If ErrProvider.CheckAndShowSummaryErrorMessage Then
                ...
                With AR
                    ...
                    .cctype = cctype
                    _OpenTransaction()
                    strResult = .Save(bolFormState = FormState.EditState, dgDetails, frmMember.dgSearchMembers)
                    ...
                    If strResult Then
                        ...
                        Else
                            MsgBox("Saved!", MsgBoxStyle.Information, "Save")
                        End If
                        Me.Close()
                        frmMember.Close()
...
#Region "GUI"
    ...
    Private Sub btnselect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnselect.Click
        With frmMember
            ...
            If txtARNo.Text = String.Empty Then
                MsgBox("Please Input control #.", MsgBoxStyle.Exclamation, "Required")
                Exit Sub
            End If
            If cboDepartment.Text = String.Empty Then
                MsgBox("Please Select Department code", MsgBoxStyle.Exclamation, "Required")
                Exit Sub
            End If
