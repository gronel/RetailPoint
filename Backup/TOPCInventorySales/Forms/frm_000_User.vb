...
#Region "User Defination"
    ...
    Sub SetEditValue()
        ...
        Try
            ...
            FillDataGrid(dgRights, "GetUserRights " & UserID, 0, 7)
    ...
    Private Sub SaveRecord()
        ...
        Try
            ...
            If ErrProvider.CheckAndShowSummaryErrorMessage Then
                ...
                ElseIf bolFormState = FormState.AddState And isRecordExist("SELECT EmpID FROM tbl_000_User WHERE EmpID='" & cboEmpID.Text.Trim & "'") Then
                ...
                ElseIf bolFormState = FormState.EditState And isRecordExist("SELECT EmpID FROM tbl_000_User WHERE EmpID='" & cboEmpID.Text.Trim & "' AND UserID<>" & UserID) Then
                    MsgBox("Employee ID already exist.", MsgBoxStyle.Exclamation, "Duplicate")
    ...
    Public Sub Searchemp(ByVal str As String)
        ...
        Try
            ...
            While rdr.Read
                ...
                _UserPic = IIf(IsDBNull(rdr("EmpPhoto")), Nothing, rdr("EmpPhoto"))
            End While
...
#Region "GUI"
    ...
    Private Sub frm_000_Client_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With ErrProvider
            .Controls.Add(cboEmpID, "Employee ID")
        ...
        ActivateCommands(FormState.LoadState)
        LoadEmployeeToMultiCombo(cboEmpID)
    ...
    Private Sub cboEmpID_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboEmpID.SelectedIndexChanged
        ...
        Searchemp("Get_Employee'" & "selectEmpID" & "','" & cboEmpID.Text & "'")
        txtEmpName.Text = _EmpName
        picPhoto.Image = BytesToImage(_UserPic)
        'showImg("Select EmpPhoto from tbl_000_Employee where EmpID='" & cboEmpID.Text & "'", "EmpPhoto", picPhoto)
