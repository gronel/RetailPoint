...
#Region "Search function"
    ...
    Dim tableName As String = "tbl_100_AR"
...
#End Region
    ...
    Public Sub ProcessFormCommand(ByVal strCmd As String) Implements IBPSCommand.ProcessFormCommand
        Select Case strCmd
            ...
            Case "Refresh"
                ...
                RefreshRecord("sp_100_Get_AR_List '" & MainForm.tsSearch.Text & "'")
            Case "Search"
                RefreshRecord("sp_100_Get_AR_List '" & MainForm.tsSearch.Text & "'")
            Case "Filter"
                Call FilterOn()
    ...
    Sub DeleteRecord()
        If vbYes = MsgBox("Are you sure you want to delete this bank?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, "Confirm Delete") Then
            ...
            _OpenTransaction()
            _Result = _DeleteRecord("tbl_100_AR", "WHERE ARNo='" & dgList.Item(0, dgList.CurrentRow.Index).Value & "'")
            _Result = _DeleteRecord("tbl_100_AR_Sub", "WHERE ARNO='" & dgList.Item(0, dgList.CurrentRow.Index).Value & "'")
    ...
    Sub NewRecord()
        ...
        ''Delete tmp table for Accountable member
...
#Region "GUI"
    Private Sub frm_100_ARList_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        setUserRights(Me.Tag)
        ActivateCommands(bolFormState)
    End Sub

    Private Sub frm_100_ARList_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frm_100_ARList_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ResizeForm(Me)
    ...
    Private Sub frm_100_ARList_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
