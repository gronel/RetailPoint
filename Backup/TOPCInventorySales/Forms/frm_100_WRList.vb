...
#Region "Search function"
    ...
    Dim tableName As String = "tbl_100_WR"
...
#End Region
    ...
    Private Sub frm_100_WRList_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub frm_100_WRList_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Public Sub ProcessFormCommand(ByVal strCmd As String) Implements IBPSCommand.ProcessFormCommand
        Select Case strCmd
            ...
            Case "Refresh"
                ...
                RefreshRecord("sp_100_Get_WR_List '" & MainForm.tsSearch.Text & "'")
            Case "Search"
                ' Call RefreshRecord("SELECT * FROM table_1 WHERE Name ='" & MainForm.tsSearch.Text & "'")
            Case "Filter"
                Call FilterOn()
            Case "FilterClear"
                Call FilterClear()
    ...
    Sub DeleteRecord()
        ...
        If vbYes = MsgBox("Are you sure you want to delete this transaction?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, "Confirm Delete") Then
            ...
            Else
                ...
                RunQuery("sp_Delete_Transaction 'WR','" & control & "'")
                Call SaveAuditTrail("Delete WR No. ", control)
                RefreshRecord("sp_100_Get_WR_List '" & MainForm.tsSearch.Text & "'")
    ...
    Private Sub ValidatePrompt()
        Dim ValidateItem As String = DBLookUp("Get_POPUp_WR", "SpecificCode")
        If ValidateItem = String.Empty Then
        Else
    ...
    Private Sub HideControls()
        ...
        End If
    End Sub
    Private Sub frm_100_WRList_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ResizeForm(Me)
    ...
    Private Sub frm_100_WRList_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
