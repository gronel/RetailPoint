...
Public Class frm_100_JOList
    Implements IBPSCommand
    Implements IBPS_SEARCH

    Dim bolFormState As clsPublic.FormState

    Private Sub frm_100_JOList_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frm_100_JOList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ResizeForm(Me)
        picLogo.Image = MainForm.picLogo.Image
        ActivateCommands(FormState.LoadState)
        RefreshRecord("sp_100_Get_JO_List '" & MainForm.tsSearch.Text & "'")
    End Sub
#Region "Search function"



    Dim tableName As String = "tbl_100_JO"
...
#End Region
    ...
    Sub DeleteRecord()
        ...
        If vbYes = MsgBox("Are you sure you want to delete this transaction?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, "Confirm Delete") Then
            ...
            Else
                ...
                RunQuery("sp_Delete_Transaction 'JO','" & control & "'")
                Call SaveAuditTrail("Delete JO No. ", control)
                RefreshRecord("sp_100_Get_JO_List '" & MainForm.tsSearch.Text & "'")
    ...
    Private Sub frm_100_JOList_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
