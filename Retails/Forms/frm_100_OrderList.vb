...
Public Class frm_100_OrderList
...
#End Region
    ...
    Private Sub frm_100_OrderList_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        setUserRights(Me.Tag)
        ActivateCommands(bolFormState)
    End Sub

    Private Sub frm_100_OrderList_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Public Sub ProcessFormCommand(ByVal strCmd As String) Implements IBPSCommand.ProcessFormCommand
        Select Case strCmd
            ...
            Case "Refresh"
                ...
                Call RefreshRecord("GetOrder'" & MainForm.tsSearch.Text & "'")
            Case "Search"
                Call RefreshRecord("GetOrder'" & MainForm.tsSearch.Text & "'")
            Case "Filter"
                Call FilterOn()
    ...
    Sub DeleteRecord()
        If vbYes = MsgBox("Are you sure you want to delete this transaction?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, "Confirm Delete") Then
            ...
            _OpenTransaction()
            _Result = _DeleteRecord("tbl_100_Order", "WHERE OrderNo='" & dgList("colOrderCode", dgList.CurrentRow.Index).Value & "'")
            _Result = _DeleteRecord("tbl_100_Order_Sub", "WHERE OrderNo='" & dgList("colOrderCode", dgList.CurrentRow.Index).Value & "'")
    ...
    Sub EditRecord()
        With frm_100_Order_Edit
            ...
            .OrderCode = dgList.Item("colOrderCode", dgList.CurrentRow.Index).Value
            .Show()
            .Focus()
    ...
    Private Sub frm_100_OrderList_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ResizeForm(Me)
