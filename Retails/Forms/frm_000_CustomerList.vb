...
Public Class frm_000_CustomerList
...
#Region "GUI"
    ...
    Private Sub frm_000_CustomerList_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
...
#End Region
    ...
    Public Sub ProcessFormCommand(ByVal strCmd As String) Implements IBPSCommand.ProcessFormCommand
        Select Case strCmd
            ...
            Case "Refresh"
                ...
                RefreshRecord("GetCustomer'" & MainForm.tsSearch.Text & "'")
            Case "Search"
                RefreshRecord("GetCustomer'" & MainForm.tsSearch.Text & "'")
            Case "Filter"
                Call FilterOn()
    ...
    Private Sub validatedd(ByVal rowindex As Integer)
        If dgList.Item("colStatus", rowindex).Value = "Inactive" Then
            dgList.Item("colStatus", rowindex).Style.BackColor = Color.Red
        End If
    End Sub

    Sub DeleteRecord()
        If vbYes = MsgBox("Are you sure you want to delete this Customer?", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, "Confirm Delete") Then
            _intDeletedRow = dgList.CurrentRow.Index
            _OpenTransaction()
            _Result = _DeleteRecord("tbl_000_Customer", "WHERE CustomerCode='" & dgList.Item("colCustomerCode", dgList.CurrentRow.Index).Value & "'")
    ...
    Sub EditRecord()
        With frm_000_Customer
            ...
            .customerCode = dgList.Item(0, dgList.CurrentRow.Index).Value
            .myParent = Me
    ...
    Private Sub frm_000_CustomerList_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ResizeForm(Me)
    ...
    Private Sub dgList_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgList.CellClick
        frm_000_Customer.customerCode = dgList.Item(0, dgList.CurrentRow.Index).Value
    End Sub
